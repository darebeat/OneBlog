            ...
            <div class="modal-body">
                <form action="/" method="post" class="form-horizontal searchForm" id="searchForm">
                    ...
                    <ul class="list-unstyled list-inline search-hot">
                        ...
                        <li><a class="pointer" rel="external nofollow"><span class="label label-info">Linux</span></a></li>
                        <li><a class="pointer" rel="external nofollow"><span class="label label-warning">Algorithm</span></a></li>
                    </ul>
                </form>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-xs-12 col-md-12 col-lg-12">
                ...
                <p><#if config.copyright!>${config.copyright} |</#if> Powered by <a href="https://gitee.com/darebeat" title="向全世界说一声,这世界我曾经来过..." data-toggle="tooltip" data-placement="right" target="_blank"><i>Darebeat</i></a>  </p>
                <#if url?? && (url == "index")>
...
<script type="text/javascript" src="${config.staticWebSite}/js/zhyd-web.min.js"></script>